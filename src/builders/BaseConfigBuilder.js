...
export class BaseConfigBuilder {
    constructor(inputString, baseConfig, lang, userAgent, groupByCountry = false, includeAutoSelect = true, skipTlsVerify = false) {
    ...
    applyConfigOverrides(overrides) {
        ...
        // - 'proxy-groups': handled by user base config (passed via constructor).
        //   Subscription-sourced proxy-groups are NOT merged to prevent
        //   unwanted groups from upstream Clash YAML subscriptions.
